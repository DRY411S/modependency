--[[
This began as a direct copy of sandbox.lua
It will still contain some of the sandbox functionality
until it is edited out
]]--
...
sandbox.on_init = function()
  ...
  log(serpent.block(script.active_mods))
  if script.active_mods["ZRecycling"] == nil then
	game.set_game_state{game_finished = true, player_won = false, can_continue = false, victorious_force = force}
  end
end
